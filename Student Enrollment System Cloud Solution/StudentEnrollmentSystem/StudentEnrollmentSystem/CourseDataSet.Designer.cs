...
namespace StudentEnrollmentSystem {
    ...
    public partial class CourseDataSet : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CourseRow AddCourseRow(string courseID, string courseName, decimal cost, System.DateTime scheduledTime) {
        ...
        public partial class CourseRow : global::System.Data.DataRow {
            ...
            public System.DateTime scheduledTime {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableCourse.scheduledTimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'scheduledTime\' in table \'Course\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCourse.scheduledTimeColumn] = value;
                }
            }
            ...
            public bool IsscheduledTimeNull() {
                return this.IsNull(this.tableCourse.scheduledTimeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetscheduledTimeNull() {
                this[this.tableCourse.scheduledTimeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace StudentEnrollmentSystem.CourseDataSetTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([courseID], [courseName], [cost], [scheduledTime]) VA" +
                "LUES (@courseID, @courseName, @cost, @scheduledTime)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@scheduledTime", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "scheduledTime", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Course] SET [courseID] = @courseID, [courseName] = @courseName, [co" +
                "st] = @cost, [scheduledTime] = @scheduledTime WHERE (([courseID] = @Original_cou" +
                "rseID))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@scheduledTime", global::System.Data.SqlDbType.Date, 0, global::System.Data.ParameterDirection.Input, 0, 0, "scheduledTime", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["StudentEnrollmentSystemConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT courseID, courseName, cost, scheduledTime FROM dbo.Course";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT courseID, courseName, cost, scheduledTime \r\nFROM dbo.Course\r\nWHERE (course" +
                "ID = @courseID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@courseID", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "courseID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO [dbo].[Course] ([courseID], [courseName], [cost], [scheduledTime]) VA" +
                "LUES (@courseID, @courseName, @cost, @scheduledTime)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@courseID", global::System.Data.SqlDbType.VarChar, 10, global::System.Data.ParameterDirection.Input, 0, 0, "courseID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@courseName", global::System.Data.SqlDbType.VarChar, 45, global::System.Data.ParameterDirection.Input, 0, 0, "courseName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@scheduledTime", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "scheduledTime", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual CourseDataSet.CourseDataTable getCourseByID(string courseID) {
        ...
        public virtual int Insert(string courseID, string courseName, decimal cost, global::System.Nullable<global::System.DateTime> scheduledTime) {
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
            ...
            if ((scheduledTime.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(scheduledTime.Value));
            }
            else {
        ...
        public virtual int Update(string courseID, string courseName, decimal cost, global::System.Nullable<global::System.DateTime> scheduledTime, string Original_courseID) {
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
            ...
            if ((scheduledTime.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(scheduledTime.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string courseName, decimal cost, global::System.Nullable<global::System.DateTime> scheduledTime, string Original_courseID) {
            return this.Update(Original_courseID, courseName, cost, scheduledTime, Original_courseID);
        }
        ...
        public virtual int InsertQuery(string courseID, string courseName, decimal cost, string scheduledTime) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            if ((courseID == null)) {
                throw new global::System.ArgumentNullException("courseID");
            }
            else {
                command.Parameters[0].Value = ((string)(courseID));
            }
            if ((courseName == null)) {
                throw new global::System.ArgumentNullException("courseName");
            }
            ...
            if ((scheduledTime == null)) {
                ...
                command.Parameters[3].Value = ((string)(scheduledTime));
            }
